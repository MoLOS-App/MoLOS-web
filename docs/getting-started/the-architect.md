---
title: The Architect
description: "The AI agent that connects MoLOS modules and their tools"
---
  ...
  <tbody>
    <tr>
      <td rowspan="3" style={{ width: '160px' }}>
        <img src="/img/brand/favicon.svg" alt="logo_FHD.png 6144x6144" width="140" />
      </td>
      <td>Ask</td>
      <td>"My bench press PR is stuck. Why?"</td>
    </tr>
    <tr>
      <td>Checks</td>
      <td>Last bench sessions (Health), meals (Meals), and calendar gaps (Calendar).</td>
    </tr>
    <tr>
      <td>Then</td>
      <td>Offers a fix and asks if you want a 2-month plan added to your GYM project (Tasks) tied to the PR goal (Goals).</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Ask</td>
      <td>"I keep missing my morning routine."</td>
    </tr>
    <tr>
      <td>Checks</td>
      <td>Task history (Tasks), sleep and energy logs (Health), and notes on distractions (Notes).</td>
    </tr>
    <tr>
      <td>Then</td>
      <td>Suggests a tighter 3-step routine and pins it to your dashboard.</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Ask</td>
      <td>"Which goal is quietly draining my week?"</td>
    </tr>
    <tr>
      <td>Checks</td>
      <td>Goals (Goals), time-blocked tasks (Tasks), and dashboard trends.</td>
    </tr>
    <tr>
      <td>Then</td>
      <td>Calls out the culprit and proposes a smaller milestone.</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Ask</td>
      <td>"Why did last month feel chaotic?"</td>
    </tr>
    <tr>
      <td>Checks</td>
      <td>Calendar load (Calendar), unfinished tasks (Tasks), and quick notes on what broke (Notes).</td>
    </tr>
    <tr>
      <td>Then</td>
      <td>Recommends a weekly reset and adds it to your dashboard.</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Ask</td>
      <td>"I want to look good on the beach without hating my life."</td>
    </tr>
    <tr>
      <td>Checks</td>
      <td>Health metrics (Health), meal choices (Meals), and your goal timeline (Goals).</td>
    </tr>
    <tr>
      <td>Then</td>
      <td>Offers a realistic plan and asks if you want the tasks created.</td>
    </tr>
  </tbody>
</table>

    ...
    metadata: [
      {
        name: "keywords",
        content:
          "local-first, ai-native, productivity, modular, self-hosted, sveltekit, life-management",
      },
    ...
    navbar: {
      ...
      items: [
        ...
        },
        {
          ...
          position: "right",
          value:
            '<a href="/docs/getting-started" class="button button--primary button--sm margin-left--md" style="text-decoration: none;">Get Started</a>',
        },
      ],
    },
    footer: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: "Discussions",
              href: "https://github.com/MoLOS-App/MoLOS/discussions",
            },
            {
              label: "Issues",
              href: "https://github.com/MoLOS-App/MoLOS/issues",
            },

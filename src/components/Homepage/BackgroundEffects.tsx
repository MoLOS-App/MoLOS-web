...
const BackgroundEffects: React.FC = () => {
  ...
  const [trail, setTrail] = useState<Array<{ x: number; y: number; id: number; size: number }>>([]);
      ...
      {Array.from({ length: 60 }, (_, i) => (
        <motion.div
          ...
          style={{
            ...
            backgroundColor: i % 3 === 0 ? 'rgba(59, 130, 246, 0.4)' : i % 3 === 1 ? 'rgba(147, 51, 234, 0.3)' : 'rgba(34, 197, 94, 0.2)',
            borderRadius: '50%',
            filter: 'blur(1px)',
          }}
          initial={{
      ...
      {trail.map((point, index) => (
        <motion.div
          ...
          style={{
            ...
            backgroundColor: index % 2 === 0 ? 'rgba(59, 130, 246, 0.6)' : 'rgba(147, 51, 234, 0.5)',
            borderRadius: '50%',
            left: point.x,
            top: point.y,
            x: '-50%',

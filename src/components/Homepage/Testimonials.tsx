...
function Testimonials({ interactive = true }: TestimonialsProps) {
  ...
  const testimonials = [
    {
      quote:
        "I voice-log my ideas throughout the day. MoLOS turns them into tasks, finds relevant notes from my knowledge base, and my AI agent synthesizes insights—all without leaving my laptop. Privacy and productivity finally align.",
      author: "Alex Chen",
    ...
    {
      quote:
        "Built a custom health-tracking module in an afternoon. The modularity is real. No fighting API limitations or vendor lock-in. Just TypeScript and creativity.",

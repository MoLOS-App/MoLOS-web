...
const FeatureList: FeatureItem[] = [
  {
    ...
    description: (
      <>
        Successful people don't go on scavenger hunts for their own files. MoLOS
        is structured for intelligence, your data is always exactly where you
        need it.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Don't spend your time managing your tools. MoLOS is pre-configured so
        you can skip the setup labor.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Stop wasting weeks designing your "perfect" workspace only to tell
        others how great it is. MoLOS works from day one with a system designed
